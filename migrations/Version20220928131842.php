 ...
 */
final class Version20220928131842 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, prod_rubrique_id INT NOT NULL, prod_fournisseur_id INT DEFAULT NULL, prod_marque VARCHAR(50) DEFAULT NULL, prod_modele VARCHAR(50) NOT NULL, prod_finition VARCHAR(50) NOT NULL, prod_lib_court VARCHAR(255) DEFAULT NULL, prod_lib_long LONGTEXT DEFAULT NULL, prod_prix NUMERIC(10, 2) NOT NULL, prod_photo VARCHAR(255) DEFAULT NULL, prod_actif TINYINT(1) NOT NULL, prod_reference VARCHAR(50) NOT NULL, prod_stock INT NOT NULL, INDEX IDX_29A5EC2797BFE4C4 (prod_rubrique_id), INDEX IDX_29A5EC275ACB195E (prod_fournisseur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rubrique (id INT AUTO_INCREMENT NOT NULL, rubriq_parente_id INT DEFAULT NULL, rubriq_nom VARCHAR(50) NOT NULL, INDEX IDX_8FA4097CC1D0A0B5 (rubriq_parente_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, is_verified TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_1D1C63B3E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
